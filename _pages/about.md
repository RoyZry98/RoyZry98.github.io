...
# 👤 Biography
Rongyu is a third-year dual Ph.D. candidate at <img src="images/nju_.png" style="width: 18px;height: auto;display: inline-block;vertical-align: middle"> **Nanjing University** and <img src="images/polyu_.png" style="width: 17px;height: auto;display: inline-block;vertical-align: middle"> **The Hong Kong Polytechnic University**, where he is co-supervised by [Prof. Yuan Du](https://iscl.nju.edu.cn/42925/list.htm) and [Prof. Dan Wang](https://wangdan.people.ust.hk/). He is also a long-term visiting student at <img src="images/pku_.png" style="width: 15px;height: auto;display: inline-block;vertical-align: middle"> **Peking University** under the supervision of [Prof. Shanghang Zhang](https://www.shanghangzhang.com). Previously, he received the M.Phil. degree from <img src="images/cuhk_.png" style="width: 18px;height: auto;display: inline-block;vertical-align: middle"> **The Chinese University of Hong Kong, Shenzhen**, supervised by [Prof. Fangxin Wang](https://mypage.cuhk.edu.cn/academics/wangfangxin/), and the B.Sc. degree from the <img src="images/qmul_.png" style="width: 15px;height: auto;display: inline-block;vertical-align: middle"> **Queen Mary University of London**. He has published over 20 papers in top-tier CCF-A and CAS-Q1 international conferences and journals such as **Nature Computational Science**, **NeurIPS**, **ICML**, **CVPR**, **AAAI**, **TMC**, and **TCSVT**, etc.
...
<div class="highlight-blocks">
  ...
  <div class="highlight-block">
    ...
    <ul>
		...
		<li><img src="images/cast.png" style="width: 15px;height: auto;display: inline-block;vertical-align: middle"> <strong>CAST</strong> Young S&T Talents Support Doctoral Student 		Program</li>
  ...
  <img src="https://img.shields.io/badge/GitHub-Stars%20350-9cf?logo=GitHub&labelColor=f6f6f6&color=EC707D&logoColor=000000&style=flat" alt="GitHub Stars">
</a></li>
    </ul>
  </div>
...
<div class="highlight-blocks">
  <div class="highlight-block">
    ...
    <div style="text-align: center;">
      <img src="images/path.png" alt="Research Focus Image" style="width:75%; height:auto; display: inline-block;">
    </div>
  </div>
</div>
...
- <img src="images/qmul_.png" style="width: 20px;height: auto;display: inline-block;vertical-align: middle"> **Queen Mary University of London** (2017.09-2021.06) B.Sc. (Engineering) with Honours, Second Class (Upper)
...
<div id="news" class="w3-container w3-margin-top-2 w3-cursive">
	  <div style="height:200px; width:100%; overflow:auto;">
		...
		<p>[11.2025] 🎉 Two paper <strong>MoASE</strong> and <strong>MoLe-VLA</strong> were accepted by <strong>AAAI 2026</strong> as <strong style="color: red;">Oral</strong> and Poster, respectively, as first author. (CCF-A).</p>
	    ...
	    <p>[05.2025] 📕 I am selected for the <strong>China Education Development Foundation (中国教育基金会) "Endeavor Scholarship — Integrated Circuit Talent Development" Program</strong> (93 recipients nationwide).</p>
	    ...
	    <p>[01.2025] 📕 I am selected for the first <strong>Doctoral Student Program of the Young S&T Talents Support Project, China Association for Science and Technology (中国科协)</strong></p>
...
<div class="pub-controls">
  ...
  *: Equal Contribution. <br>
  CCF-A/CAS-Q1 as (Co-)First-author: <venue>NCS</venue>x 1, <venue>AAAI</venue>x 3, <venue>ACM MM</venue>x 1, <venue>TMC</venue>x 3, <venue>TCSVT</venue>x 1 <br><br></p>
...
<ul id="publications">
  <li first_authored=true category="Efficiency">
    <venue>CoLM'26</venue><pt>MoANT: Mixture-of-Rank-One-Experts with semantic-aware Intuition for Multi-task Large Language Model Finetuning</pt><br>
...
<div class="description">
  <ul class="ul-edu mb-0" style="list-style: none; padding-left: 0;">
    ...
    <li class="highlight-block" style="position: relative; padding: 16px 120px 16px 72px; margin-bottom: 18px;">
      ...
      <span style="position: absolute; left: 16px; top: 16px; bottom: 16px; width: 40px; display: flex; align-items: center; justify-content: center; border-radius: 12px; background: #eef5ff; color: #4f6f8f;">
        <i class="fas fa-microscope" aria-hidden="true" style="font-size: 20px;"></i>
      </span>
